<%-- 
    ...
    Created on : 19/07/2021, 11:19:09 PM
    Author     : Microsoft
--%>
...
<html>
    ...
    <body>
        ...
        <main>
            ...
            <div class="re">
                <t:form action="ControladorBorrarProveedor" method="post">
                    <h1 class="titulo">BORRAR PROVEEDOR</h1>
                    <div class="mb-3">
                        <label>Ingrese el RUC del proveedor a borrar:</label>
