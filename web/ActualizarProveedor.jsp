...
<html>
    ...
    <body>
        ...
        <main>
            ...
            <div class="re">
                <t:form action="ControladorActualizarProveedor" method="post">
                    ...
                    <div class="mb-3">
                        <label>Nombre:</label>
                        <t:text property="nombre" styleClass="form-control"/>
                    </div>
                    <div class="mb-3">
                        <label>Direccion:</label>
                        <t:text property="direccion" styleClass="form-control"/>
                    </div>
                    <div class="d-grid gap-2">
                        <t:submit styleClass="btn btn-outline-success" styleId="acc" value="Actualizar"/>
                    </div>
                </t:form>
            </div>
        </main>
