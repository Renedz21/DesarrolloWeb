<%-- 
    Document   : Registro
    Created on : 15/07/2021, 11:22:15 PM
    Author     : Microsoft
--%>
...
<html>
    ...
    <body>
        ...
        <div class="formulario">
            <x:form action="EmpleadoControl" method="post">
                <h1 class="titulo">REGISTRATE AQUI!</h1>
                <div class="mb-3">
                    <label>Codigo:</label>
                    <x:text styleClass="form-control" property="codigo"/>
                </div>
                <div class="mb-3">
                    <label>Nombre:</label><br>
                    <x:text styleClass="form-control" property="nombre"/>
                </div>
                <div class="mb-3">
                    <label>Tipo:</label><br>
                    <x:text styleClass="form-control" property="tipo"/>
                </div>
                <div class="mb-3">
                ...
                <div class="d-grid gap-2">
                    <x:submit styleClass="btn btn-success" styleId="boton" value="Grabar"/>
                </div>
