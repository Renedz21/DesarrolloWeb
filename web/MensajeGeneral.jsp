    ...
    <body style="background:transparent">
        <header class="cabecera">
            <div class="arriba container-fluid">
                ...
                <% PresentadorGeneral t = (PresentadorGeneral)session.getAttribute("pp"); %>
                
                
                <div class="text">
                    <h1 class="titulo-general">MENSAJE DE CONFIRMACION</h1>
                    <div class="container">
                        <div class="alert alert-warning" role="alert">
                            <h3 class="mensaje"><%= t.getMensaje() %></h3>
                        </div>
                        <a class="btn btn-info alerta" href="Menu.jsp">Volver al menu</a>
                    </div>
                </div>
            </div>
        </header>
