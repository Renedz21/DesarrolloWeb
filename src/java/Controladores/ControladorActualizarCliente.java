 ...
 * @author Microsoft
 */
public class ControladorActualizarCliente extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
            ...
            throws Exception {
        FormularioCliente f = (FormularioCliente) form;
        
        pp = new PresentadorGeneral();
        cs = new Cliente_Servicio_Imp();
        
        pp.setMensaje(cs.Actualizar(f.getCodigo(),f.getNombre(),f.getDireccion()));
